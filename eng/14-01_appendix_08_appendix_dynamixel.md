...
> **Source**: [https://emanual.robotis.com/docs/en/platform/turtlebot3/appendix_dynamixel](https://emanual.robotis.com/docs/en/platform/turtlebot3/appendix_dynamixel)
...
- Basic Features Improved Torque with Compact SizeEnhanced Durability and ExpandabilityHollow Back Case Minimizes Cable Stress (3-way-routing)Direct Screw Assembly to the Case (without Nut Insert)Improved Heat Sink Featuring Aluminum Case
...
- Various Control Functions 6 Operating ModesCurrent-Based Torque Control (4096 steps, 2.69mA/step)Profile Control for Smooth Motion PlanningTrajectory Data and Moving Status (In-Position, Following Error, etc.)Energy Saving (Reduced Current from 100mA to 40mA)
  - 6 Operating Modes
...
- More information for actuators can be found at below ROBOTIS e-Manual links. XL430-W250for TurtleBot3 BurgerXM430-W210for TurtleBot3 Waffle and Waffle Pi
...
![](img/dynamixel_sdk_concept_logo.jpg)
...
- More information for DYNAMIXEL SDK can be found at below ROBOTIS e-Manual and GitHub links. e-Manual of DYNAMIXEL SDKGitHub Repository of DYNAMIXEL SDK
  - [e-Manual of DYNAMIXEL SDK](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_sdk/overview/)
  - [GitHub Repository of DYNAMIXEL SDK](https://github.com/ROBOTIS-GIT/DynamixelSDK)
