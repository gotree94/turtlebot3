...
**Prerequisites for use of actual TurtleBot3**

### 8.1.2 What you need for Autonomous Driving
...
**Autorace Package Installation for an actual TurtleBot3**
...
```
$ sudo apt install ros-noetic-image-transport ros-noetic-image-transport-plugins ros-noetic-cv-bridge ros-noetic-vision-opencv python3-opencv libopencv-dev ros-noetic-image-proc ros-noetic-
```
...
https://youtu.be/Qx3vbgoSNO8?si=zgZigMIInJ6pUWpr
